...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    var itemStore: ItemStore! // = ItemStoreWithFirebase()  // ItemStore()
...
//        let itemsViewController = window?.rootViewController as! ItemsViewController
        ...
        itemStore = ItemStoreWithFireStore()
        imageStore = ImageStoreWithFirebase()
        
        let navigationController = window?.rootViewController as! UINavigationController
        let itemsViewController = navigationController.viewControllers[0] as! ItemsViewController
